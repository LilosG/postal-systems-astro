        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold text-[hsl(var(--postal-navy))] mb-6 font-poppins leading-tight">
                ...
                <br />
                <span className="text-[hsl(var(--postal-red))]">
                  Done Right.
                </span>
              </h1>

              <p className="text-xl text-[hsl(var(--postal-slate))] mb-8 leading-relaxed font-inter">
                USPS-approved vendor & licensed California contractor serving
                San Diego County. We install, repair & upgrade community and
                commercial mailboxes.
              </p>

              {/* Trust Badges */}
              <div className="flex flex-wrap gap-3 mb-8">
                <span className="trust-badge">USPS-Approved</span>
                <span className="trust-badge">Licensed/Bonded/Insured</span>
                <span className="trust-badge">20+ Years Experience</span>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-[var(--shadow-hero)]">
              <img width="1200" height="675" loading="eager" fetchpriority="high"
                src={heroImage}
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-[var(--shadow-card)]">
              <div className="text-center">
                <div className="text-2xl font-bold text-[hsl(var(--postal-red))] font-poppins">
                  CSLB
                </div>
                <div className="text-sm text-[hsl(var(--postal-slate))] font-semibold">
                  #904106
                </div>
