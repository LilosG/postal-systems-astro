  ...
  const projects = [
    {
      ...
      location: "San Marcos",
      description: "Complete cluster box unit replacement for 200-unit residential community with ADA compliance upgrades.",
    ...
    },
    {
      ...
      location: "Carlsbad",
      description: "Modern 4C horizontal mailbox installation for luxury apartment complex with integrated parcel system.",
    ...
    },
    {
      ...
      description: "Large-scale parcel locker installation serving multiple office buildings with secure package delivery.",
      ...
      <div className="container mx-auto px-4 max-w-[1140px]">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[hsl(var(--postal-slate))] max-w-2xl mx-auto font-inter">
            See our recent installations across San Diego County communities and commercial properties.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <div key={index} className="bg-white rounded-xl overflow-hidden shadow-[var(--shadow-card)] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group cursor-pointer">
              <div className="aspect-video overflow-hidden relative">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <h3 className="font-semibold text-lg font-poppins">{project.title}</h3>
                  <p className="text-sm opacity-90 font-inter">{project.location}</p>
                </div>
              </div>
