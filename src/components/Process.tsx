import { MapPin, FileText, Calendar, Hammer, CheckCircle } from 'lucide-react'
...
const Process = () => {
  const steps = [
    ...
    },
    {
      ...
      title: 'Quote',
      description:
        'Detailed proposal with materials, scope, timeline, and pricing.',
    },
    {
      icon: Calendar,
      title: 'Schedule',
      description:
        'Coordinate installation date, permits, and material delivery.',
    },
    {
      icon: Hammer,
      title: 'Install',
      description:
        'Professional installation with pads, anchors, and leveling.',
    },
    {
      icon: CheckCircle,
      title: 'USPS Handover',
      description:
        'Final inspection and official handover of your mailbox system.',
    },
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[hsl(var(--postal-slate))] max-w-2xl mx-auto">
            A streamlined 5-step process that ensures your mailbox installation
