  ...
  const services = [
    {
      ...
      description: "USPS-approved community mailbox installations for residential developments.",
      image: cbuImage,
      thumb: cbuImage,
    ...
    },
    {
      ...
      description: "Modern mailroom solutions for apartments and office buildings.",
      image: fourCThumb,
      thumb: fourCThumb,
    ...
    },
    {
      ...
      description: "Secure package delivery systems for modern e-commerce needs.",
      image: parcelThumb,
      thumb: parcelThumb,
    ...
    },
    {
      ...
      description: "Maintenance services and hardware upgrades for existing systems.",
      image: lockThumb,
      thumb: lockThumb,
      ...
      <div className="container mx-auto px-4 max-w-[1140px]">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[hsl(var(--postal-slate))] max-w-2xl mx-auto font-inter">
            Complete mailbox solutions from installation to maintenance, all USPS-approved and professionally executed.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <a key={index} href="#contact" className="card-service group cursor-pointer h-full flex flex-col">
